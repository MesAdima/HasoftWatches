    ...
    <div class="header-top-bar">
      <div class="container">
        ...
        <div class="header-call-to-action">
          <a href="price-listing.html" class="btn btn-default"><i class="fa fa-plus"></i> Intl. Orders</a>
      ...
      <div class="container">
        <nav>
          ...
          <ul class="primary-nav list-unstyled">
            ...
            <li class="bg-color"><a href="price-listing.html">Price Listing</a></li>
    ...
    <div class="container">
      <div class="page-content">
        <div class="price-listing">
          <h3>HOW<strong>MUCH</strong> DO You PAY?</h3>
          ...
          <h3 class="team"><strong>Our</strong> Plan</h3>

          <div class="row">

            <div class="col-md-6 col-sm-6 col-lg-3">
              <div class="pricing-table">
                <h3><strong>Bronze</strong> Plan</h3>
            ...
            <div class="col-md-6 col-sm-6 col-lg-3">
              <div class="pricing-table">
                <h3><strong>Silvar</strong> Plan</h3>
